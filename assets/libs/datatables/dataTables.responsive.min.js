...
*/
(function (d) { typeof define === 'function' && define.amd ? define(['jquery', 'datatables.net'], function (l) { return d(l, window, document) }) : typeof exports === 'object' ? module.exports = function (l, j) { l || (l = window); if (!j || !j.fn.dataTable)j = require('datatables.net')(l, j).$; return d(j, l, l.document) } : d(jQuery, window, document) })(function (d, l, j, q) {
...
'-' + d; if (n[e]) { for (var a = a.cell(b, d).node(), d = n[e][0].parentNode.childNodes, b = [], f = 0, g = d.length; f < g; f++)b.push(d[f]); d = 0; for (f = b.length; d < f; d++)a.appendChild(b[d]); n[e] = q }
    ...
    if (!o.versionCheck || !o.versionCheck('1.10.10')) throw 'DataTables Responsive requires DataTables 1.10.10 or newer'; this.s = {dt: new o.Api(a), columns: [], current: []}; this.s.dt.settings()[0].responsive || (b && typeof b.details === 'string' ? b.details = {type: b.details} : b && !1 === b.details ? b.details = {type: !1}
  ...
  }; d.extend(i.prototype, {_constructor: function () {
    var a = this, b = this.s.dt, c = b.settings()[0], e = d(l).width(); b.settings()[0]._responsive = this; d(l).on('resize.dtr orientationchange.dtr', o.util.throttle(function () { var b = d(l).width(); b !== e && (a._resize(), e = b) })); c.oApi._fnCallbackReg(c, 'aoRowCreatedCallback', function (e) {
      d.inArray(!1, a.s.current) !== -1 && d('>td, >th',
  ...
  _columnsVisiblity: function (a) {
    var b = this.s.dt, c = this.s.columns, e, f, g = c.map(function (a, b) { return {columnIdx: b, priority: a.priority} }).sort(function (a, b) { return a.priority !== b.priority ? a.priority - b.priority : a.columnIdx - b.columnIdx }), h = d.map(c, function (e, c) {
        return !1 === b.column(c).visible()
          ? 'not-visible' : e.auto && e.minWidth === null ? !1 : !0 === e.auto ? '-' : d.inArray(a, e.includeIn) !== -1
      }), m = 0; e = 0; for (f = h.length; e < f; e++)!0 === h[e] && (m += c[e].minWidth); e = b.settings()[0].oScroll; e = e.sY || e.sX ? e.iBarWidth : 0; m = b.table().container().offsetWidth - e - m; e = 0; for (f = h.length; e < f; e++)c[e].control && (m -= c[e].minWidth); var s = !1; e = 0; for (f = g.length; e < f; e++) { var k = g[e].columnIdx; h[k] === '-' && (!c[k].control && c[k].minWidth) && (s || m - c[k].minWidth < 0 ? (s = !0, h[k] = !1) : h[k] = !0, m -= c[k].minWidth) }g = !1; e = 0; for (f = c.length; e < f; e++) {
      if (!c[e].control &&
!c[e].never && !1 === h[e]) { g = !0; break }
    }e = 0; for (f = c.length; e < f; e++)c[e].control && (h[e] = g), h[e] === 'not-visible' && (h[e] = !1); d.inArray(!0, h) === -1 && (h[0] = !0); return h
  },
  _classLogic: function () {
    var a = this, b = this.c.breakpoints, c = this.s.dt, e = c.columns().eq(0).map(function (a) { var b = this.column(a), e = b.header().className, a = c.settings()[0].aoColumns[a].responsivePriority; a === q && (b = d(b.header()).data('priority'), a = b !== q ? 1 * b : 1E4); return {className: e, includeIn: [], auto: !1, control: !1, never: e.match(/\bnever\b/) ? !0 : !1, priority: a} }),
      f = function (a, b) { var c = e[a].includeIn; d.inArray(b, c) === -1 && c.push(b) }, g = function (d, c, g, k) { if (g) if (g === 'max-') { k = a._find(c).width; c = 0; for (g = b.length; c < g; c++)b[c].width <= k && f(d, b[c].name) } else if (g === 'min-') { k = a._find(c).width; c = 0; for (g = b.length; c < g; c++)b[c].width >= k && f(d, b[c].name) } else { if (g === 'not-') { c = 0; for (g = b.length; c < g; c++)b[c].name.indexOf(k) === -1 && f(d, b[c].name) } } else e[d].includeIn.push(c) }; e.each(function (a, e) {
      for (var c = a.className.split(' '), f = !1, i = 0, l = c.length; i < l; i++) {
        var j = d.trim(c[i])
        if (j === 'all') { f = !0; a.includeIn = d.map(b, function (a) { return a.name }); return } if (j === 'none' || a.never) { f = !0; return } if (j === 'control') { f = !0; a.control = !0; return }d.each(b, function (a, b) { var d = b.name.split('-'), c = j.match(RegExp('(min\\-|max\\-|not\\-)?(' + d[0] + ')(\\-[_a-zA-Z0-9])?')); c && (f = !0, c[2] === d[0] && c[3] === '-' + d[1] ? g(e, b.name, c[1], c[2] + c[3]) : c[2] === d[0] && !c[3] && g(e, b.name, c[1], c[2])) })
      }f || (a.auto = !0)
    }); this.s.columns = e
  },
...
f.display(a, b, function () { return f.renderer(e, a[0], c._detailsObj(a[0])) }); (!0 === g || !1 === g) && d(e.table().node()).triggerHandler('responsive-display.dt', [e, a, g, b])
  ...
  _detailsInit: function () {
    var a = this, b = this.s.dt, c = this.c.details; c.type === 'inline' && (c.target = 'td:first-child, th:first-child'); b.on('draw.dtr', function () { a._tabIndexes() }); a._tabIndexes(); d(b.table().body()).on('keyup.dtr', 'td, th', function (a) { a.keyCode === 13 && d(this).data('dtr-keyboard') && d(this).click() }); var e = c.target; d(b.table().body()).on('click.dtr mousedown.dtr mouseup.dtr',
      typeof e === 'string' ? e : 'td, th', function (c) { if (d(b.table().node()).hasClass('collapsed') && d.inArray(d(this).closest('tr').get(0), b.rows().nodes().toArray()) !== -1) { if (typeof e === 'number') { var g = e < 0 ? b.columns().eq(0).length + e : e; if (b.cell(this).index().column !== g) return }g = b.row(d(this).closest('tr')); c.type === 'click' ? a._detailsDisplay(g, false) : c.type === 'mousedown' ? d(this).css('outline', 'none') : c.type === 'mouseup' && d(this).blur().css('outline', '') } })
  },
  ...
  _find: function (a) { for (var b = this.c.breakpoints, c = 0, e = b.length; c < e; c++) if (b[c].name === a) return b[c] },
  _redrawChildren: function () { var a = this, b = this.s.dt; b.rows({page: 'current'}).iterator('row', function (c, e) { b.row(e); a._detailsDisplay(b.row(e), !0) }) },
  _resize: function () {
    var a = this, b = this.s.dt, c = d(l).width(),
      e = this.c.breakpoints, f = e[0].name, g = this.s.columns, h, m = this.s.current.slice(); for (h = e.length - 1; h >= 0; h--) if (c <= e[h].width) { f = e[h].name; break } var i = this._columnsVisiblity(f); this.s.current = i; e = !1; h = 0; for (c = g.length; h < c; h++) if (!1 === i[h] && !g[h].never && !g[h].control && !1 === !b.column(h).visible()) { e = !0; break }d(b.table().node()).toggleClass('collapsed', e); var k = !1, j = 0; b.columns().eq(0).each(function (b, c) { !0 === i[c] && j++; i[c] !== m[c] && (k = !0, a._setColumnVis(b, i[c])) }); k && (this._redrawChildren(), d(b.table().node()).trigger('responsive-resize.dt',
      [b, this.s.current]), b.page.info().recordsDisplay === 0 && d('td', b.table().body()).eq(0).attr('colspan', j))
  },
  _resizeAuto: function () {
    var a = this.s.dt, b = this.s.columns; if (this.c.auto && d.inArray(!0, d.map(b, function (a) { return a.auto })) !== -1) {
      d.isEmptyObject(n) || d.each(n, function (b) { b = b.split('-'); r(a, 1 * b[0], 1 * b[1]) }); a.table().node(); var c = a.table().node().cloneNode(!1), e = d(a.table().header().cloneNode(!1)).appendTo(c), f = d(a.table().body()).clone(!1, !1).empty().appendTo(c), g = a.columns().header().filter(function (b) { return a.column(b).visible() }).to$().clone(!1).css('display',
        'table-cell').css('min-width', 0); d(f).append(d(a.rows({page: 'current'}).nodes()).clone(!1)).find('th, td').css('display', ''); if (f = a.table().footer()) { var f = d(f.cloneNode(!1)).appendTo(c), h = a.columns().footer().filter(function (b) { return a.column(b).visible() }).to$().clone(!1).css('display', 'table-cell'); d('<tr/>').append(h).appendTo(f) }d('<tr/>').append(g).appendTo(e); this.c.details.type === 'inline' && d(c).addClass('dtr-inline collapsed'); d(c).find('[name]').removeAttr('name'); d(c).css('position', 'relative')
  ...
  _setColumnVis: function (a, b) { var c = this.s.dt, e = b ? '' : 'none'; d(c.column(a).header()).css('display', e); d(c.column(a).footer()).css('display', e); c.column(a).nodes().to$().css('display', e); d.isEmptyObject(n) || c.cells(null, a).indexes().each(function (a) { r(c, a.row, a.column) }) },
  _tabIndexes: function () {
    var a =
this.s.dt, b = a.cells({page: 'current'}).nodes().to$(), c = a.settings()[0], e = this.c.details.target; b.filter('[data-dtr-keyboard]').removeData('[data-dtr-keyboard]'); typeof e === 'number' ? a.cells(null, e, {page: 'current'}).nodes().to$().attr('tabIndex', c.iTabIndex).data('dtr-keyboard', 1) : (e === 'td:first-child, th:first-child' && (e = '>td:first-child, >th:first-child'), d(e, a.rows({page: 'current'}).nodes()).attr('tabIndex', c.iTabIndex).data('dtr-keyboard', 1))
  }}); i.breakpoints = [{name: 'desktop', width: Infinity}, {name: 'tablet-l',
    ...
    childRowImmediate: function (a, b, c) {
      if (!b && a.child.isShown() || !a.responsive.hasHidden()) {
        return a.child(!1), d(a.node()).removeClass('parent'),
        !1
      } a.child(c(), 'child').show(); d(a.node()).addClass('parent'); return !0
    },
    modal: function (a) {
      return function (b, c, e) {
        if (c)d('div.dtr-modal-content').empty().append(e()); else {
          ...
          d(j).on('keyup.dtr', function (a) { a.keyCode === 27 && (a.stopPropagation(), f()) })
        }a && a.header && d('div.dtr-modal-content').prepend('<h2>' + a.header(b) + '</h2>')
      }
    }}; var n = {}; i.renderer = {listHiddenNodes: function () {
  ...
  tableAll: function (a) {
    ...
    var a = this.context[0]; return a._responsive ? d.inArray(!1, a._responsive.s.current) !== -1
      : !1
    ...
    if (a.namespace === 'dt' && (d(b.nTable).hasClass('responsive') || d(b.nTable).hasClass('dt-responsive') || b.oInit.responsive || o.defaults.responsive)) {
