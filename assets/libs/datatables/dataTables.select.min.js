...
*/
(function (e) { typeof define === 'function' && define.amd ? define(['jquery', 'datatables.net'], function (i) { return e(i, window, document) }) : typeof exports === 'object' ? module.exports = function (i, l) { i || (i = window); if (!l || !l.fn.dataTable)l = require('datatables.net')(i, l).$; return e(l, i, i.document) } : e(jQuery, window, document) })(function (e, i, l, h) {
  function u (a, c, b) {
...
function (b, c) { var d = a.rows({search: 'applied'}).indexes(); if (d.indexOf(b) > d.indexOf(c)) var f = c, c = b, b = f; var e = !1; return d.filter(function (a) { a === b && (e = !0); return a === c ? (e = !1, !0) : e }) }; !a.cells({selected: !0}).any() && !b ? (d = d(0, c.column), b = f(0, c.row)) : (d = d(b.column, c.column), b = f(b.row, c.row)); b = a.cells(b, d).flatten(); a.cells(c, {selected: !0}).any() ? a.cells(b).deselect() : a.cells(b).select()
    ...
    var c = e(a.table().container()), b = a.settings()[0], d = b._select.selector, f; c.on('mousedown.dtSelect', d, function (b) { if (b.shiftKey || b.metaKey || b.ctrlKey)c.css('-moz-user-select', 'none').one('selectstart.dtSelect', d, function () { return !1 }); i.getSelection && (f = i.getSelection()) }).on('mouseup.dtSelect', d, function () { c.css('-moz-user-select', '') }).on('click.dtSelect', d, function (b) {
      var c = a.select.items(); if (f) {
        ...
        var h = e.Event('user-select.dt'); j(a, h, [c, g, b]); h.isDefaultPrevented() || (h = g.index(), c === 'row' ? (c = h.row, r(b, a, d, 'row', c)) : c === 'column' ? (c = g.index().column, r(b, a, d, 'column', c)) : c === 'cell' && (c = g.index(), r(b, a, d, 'cell', c)),
        d._select_lastCell = h)
      }
    }); e('body').on('click.dtSelect' + a.table().node().id, function (c) { b._select.blurable && !e(c.target).parents().filter(a.table().container()).length && (e(c.target).parents('html').length !== 0 && !e(c.target).parents('div.DTE').length) && o(b, !0) })
  } function j (a, c, b, d) { if (!d || a.flatten().length) typeof c === 'string' && (c += '.dt'), b.unshift(a), e(a.table().node()).trigger(c, b) } function y (a) {
    var c = a.settings()[0]; if (c._select.info && c.aanFeatures.i && a.select.style() !== 'api') {
    ...
    var f = a[c + 's']({search: 'applied'}).indexes(),
      d = e.inArray(d, f), k = e.inArray(b, f); if (!a[c + 's']({selected: !0}).any() && d === -1)f.splice(e.inArray(b, f) + 1, f.length); else { if (d > k) var g = k, k = d, d = g; f.splice(k + 1, f.length); f.splice(0, d) }a[c](b, {selected: !0}).any() ? (f.splice(e.inArray(b, f), 1), a[c + 's'](f).deselect()) : a[c + 's'](f).select()
  } function o (a, c) { if (c || a._select.style === 'single') { var b = new g.Api(a); b.rows({selected: !0}).deselect(); b.columns({selected: !0}).deselect(); b.cells({selected: !0}).deselect() } } function r (a, c, b, d, f) {
    var e = c.select.style(), g = c[d](f,
      {selected: !0}).any(); e === 'os' ? a.ctrlKey || a.metaKey ? c[d](f).select(!g) : a.shiftKey ? d === 'cell' ? u(c, f, b._select_lastCell || null) : z(c, d, f, b._select_lastCell ? b._select_lastCell[d] : null) : (a = c[d + 's']({selected: !0}), g && a.flatten().length === 1 ? c[d](f).deselect() : (a.deselect(), c[d](f).select())) : e == 'multi+shift' ? a.shiftKey ? d === 'cell' ? u(c, f, b._select_lastCell || null) : z(c, d, f, b._select_lastCell ? b._select_lastCell[d] : null) : c[d](f).select(!g) : c[d](f).select(!g)
  } function p (a, c) {
    return function (b) {
...
a, c)
    ...
    var c = a.settings()[0], b = c.oInit.select, d = g.defaults.select, b = b === h ? d : b, d = 'row', f = 'api', k = !1, v = !0, w = 'td, th', i = 'selected', j = !1; c._select = {}; if (!0 === b)f = 'os', j = !0; else if (typeof b === 'string')f = b, j = !0; else if (e.isPlainObject(b) && (b.blurable !== h && (k = b.blurable), b.info !== h && (v = b.info), b.items !== h && (d = b.items), f = b.style !==
h ? b.style : 'os', j = !0, b.selector !== h && (w = b.selector), b.className !== h))i = b.className; a.select.selector(w); a.select.items(d); a.select.style(f); a.select.blurable(k); a.select.info(v); c._select.className = i; e.fn.dataTable.ext.order['select-checkbox'] = function (b, c) { return this.api().column(c, {order: 'index'}).nodes().map(function (c) { return b._select.items === 'row' ? e(c).parent().hasClass(b._select.className) : b._select.items === 'cell' ? e(c).hasClass(b._select.className) : !1 }) }; !j && e(a.table().node()).hasClass('selectable') &&
a.select.style('os')
    ...
    var c = c.selected, d, f = []; if (c === h) return b; for (var e = 0, g = b.length; e < g; e++) {
      d = a.aoData[b[e].row], (!0 === c && d._selected_cells &&
...
a
    ...
    return a === h ? this.context[0]._select.style : this.iterator('table', function (c) {
      c._select.style = a; if (!c._select_init) {
        var b = new g.Api(c); c.aoRowCreatedCallback.push({fn: function (b, a, d) {
...
a._selected_cells && a._selected_cells[b]) && e(a.anCells[b]).addClass(c._select.className)
      ...
      } var d = new g.Api(c); q(d); a !== 'api' && x(d); j(new g.Api(c), 'selectStyle', [a])
    })
  }); m('select.selector()', function (a) { return a === h ? this.context[0]._select.selector : this.iterator('table', function (c) { q(new g.Api(c)); c._select.selector = a; c._select.style !== 'api' && x(new g.Api(c)) }) }); n('rows().select()', 'row().select()', function (a) {
...
c.aoData[b.row], d = a._selected_cells; a.anCells && (!d || !d[b.column]) && e(a.anCells[b.column]).removeClass(c._select.className)
  ...
  }); var t = 0; e.extend(g.ext.buttons, {selected: {text: p('selected', 'Selected'),
    className: 'buttons-selected',
    limitTo: ['rows', 'columns', 'cells'],
    init: function (a, c, b) { var d = this; b._eventNamespace = '.select' + t++; a.on(s(b), function () { d.enable(e.inArray('rows', b.limitTo) !== -1 && a.rows({selected: !0}).any() || e.inArray('columns', b.limitTo) !== -1 && a.columns({selected: !0}).any() || e.inArray('cells', b.limitTo) !== -1 && a.cells({selected: !0}).any() ? !0 : !1) }); this.disable() },
    destroy: function (a,
      c, b) { a.off(b._eventNamespace) }},
  selectedSingle: {text: p('selectedSingle', 'Selected single'), className: 'buttons-selected-single', init: function (a, c, b) { var d = this; b._eventNamespace = '.select' + t++; a.on(s(b), function () { var b = a.rows({selected: !0}).flatten().length + a.columns({selected: !0}).flatten().length + a.cells({selected: !0}).flatten().length; d.enable(b === 1) }); this.disable() }, destroy: function (a, c, b) { a.off(b._eventNamespace) }},
  selectAll: {text: p('selectAll', 'Select all'),
    className: 'buttons-select-all',
    action: function () {
      this[this.select.items() +
's']().select()
    }},
  selectNone: {text: p('selectNone', 'Deselect all'), className: 'buttons-select-none', action: function () { o(this.settings()[0], !0) }, init: function (a, c, b) { var d = this; b._eventNamespace = '.select' + t++; a.on(s(b), function () { var b = a.rows({selected: !0}).flatten().length + a.columns({selected: !0}).flatten().length + a.cells({selected: !0}).flatten().length; d.enable(b > 0) }); this.disable() }, destroy: function (a, c, b) { a.off(b._eventNamespace) }}}); e.each(['Row', 'Column', 'Cell'], function (a, c) {
    var b = c.toLowerCase()
  ...
  }); e(l).on('preInit.dt.dtSelect', function (a, c) { a.namespace === 'dt' && g.select.init(new g.Api(c)) }); return g.select
})
